...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(train_annotation_path, encoding='utf-8') as ft:
        train_lines = ft.readlines()
    with open(test_annotation_path, encoding='utf-8') as fv:
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            train_acc, val_acc = fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step,
                                               epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler,
        ...
        plt.ylabel("Acc")
        plt.legend()
        plt.savefig('acc10tr-epoch400jpg')
        if local_rank == 0:
